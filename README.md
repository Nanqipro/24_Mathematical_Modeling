...
<p align="center">
  <img src="docs/readme-assets/award-highlight.svg" alt="2024 年华为杯中国研究生数学建模竞赛二等奖获奖信息" width="100%">
</p>

2024 年，南昌大学参赛团队凭《基于视频监控与深度学习的高速公路拥堵预测与应急车道启用决策研究》，获得第二十一届“华为杯”中国研究生数学建模竞赛**二等奖**。

本次参赛围绕高速公路拥堵预警与应急车道启用问题展开，完成了四个相互衔接的建模任务：从多点视频中提取交通流信息、预测拥堵状态、量化应急车道启用效果，并研究监控点的优化布置。当前仓库整理并公开了其中的车辆跟踪原型、派生交通数据、预测结果与可复核分析脚本。

| 项目 | 信息 |
|---|---|
| 赛事 | 2024 年第二十一届“华为杯”中国研究生数学建模竞赛 |
| 奖项 | 二等奖 |
| 参赛单位 | 南昌大学 |
| 研究主题 | 高速公路拥堵预测、预警与应急车道启用决策 |
| 获奖时间 | 2024 年 12 月 |

> 获奖信息已根据团队证书核验。为保护个人隐私，公开仓库不展示参赛者姓名和证书编号。
